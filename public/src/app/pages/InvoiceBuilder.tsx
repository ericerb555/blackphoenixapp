...
import { Plus, Trash2, Send, Download, Copy, Check, FileText, DollarSign, Clock, ChevronDown, Eye, ArrowLeft, Zap, CheckCircle, UserPlus, X, Search, User } from 'lucide-react';
