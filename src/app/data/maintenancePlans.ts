...
export const SERVICE_CATALOG: Record<EntityType, ServiceItem[]> = {
  ...
  condo: [
    ...
    // Unit turnover services are available to associations coordinating owner/rental turns.
    { id: 'ca-turn-paint',      category: 'Unit Turnover', name: 'Quick Turn Paint Package',              description: 'Fast vacancy paint, patches and trim touch-ups for an individual unit.', baseMonthlyPrice: 650, unit: 'per unit turn', recommended: true },
    { id: 'ca-turn-kitchen',    category: 'Unit Turnover', name: 'Kitchen Refresh Add-On',                 description: 'Kitchen fixtures, cabinet hardware, paint and minor repair refresh.', baseMonthlyPrice: 2450, unit: 'per unit / quoted add-on' },
    { id: 'ca-turn-bathroom',   category: 'Unit Turnover', name: 'Bathroom Refresh Add-On',                description: 'Bathroom fixtures, vanity, caulk, paint and tile repair refresh.', baseMonthlyPrice: 1950, unit: 'per unit / quoted add-on' },
    { id: 'ca-turn-flooring',   category: 'Unit Turnover', name: 'Flooring Replacement Add-On',             description: 'Flooring replacement allowance; final material and room count are confirmed before work.', baseMonthlyPrice: 1800, unit: 'per unit / quoted add-on' },
    // Plumbing
  ...
  landlord: [
    ...
    // Quick unit turnover & renovation add-ons — selected individually and priced per unit/turn.
    { id: 'll-turn-quick-paint', category: 'Unit Turnover', name: 'Quick Turn Paint Package',             description: 'Fast patch, prep, walls, trim and touch-ups for a rent-ready unit.', baseMonthlyPrice: 650, unit: 'per unit turn', recommended: true },
    { id: 'll-turn-kitchen',     category: 'Unit Turnover', name: 'Kitchen Turnover Refresh',              description: 'Cabinet hardware, paint, fixtures, sink/faucet and appliance-ready refresh. Scope confirmed before work.', baseMonthlyPrice: 2450, unit: 'per unit / quoted add-on', recommended: true },
    { id: 'll-turn-bathroom',    category: 'Unit Turnover', name: 'Bathroom Turnover Refresh',             description: 'Vanity, toilet, fixtures, caulk, paint and tile repair refresh. Scope confirmed before work.', baseMonthlyPrice: 1950, unit: 'per unit / quoted add-on', recommended: true },
    { id: 'll-turn-flooring',    category: 'Unit Turnover', name: 'Flooring Replacement Allowance',        description: 'Remove and replace damaged flooring; final scope depends on room count, material and subfloor condition.', baseMonthlyPrice: 1800, unit: 'per unit / quoted add-on', recommended: true },
    { id: 'll-turn-full',        category: 'Unit Turnover', name: 'Full Make-Ready Turn Package',          description: 'Coordinated clean, paint, minor repairs, punch list and move-in readiness review.', baseMonthlyPrice: 3200, unit: 'per unit turn', recommended: true },
    // HVAC
