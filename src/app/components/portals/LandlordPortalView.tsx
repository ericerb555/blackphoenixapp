...
export default function LandlordPortalView() {
  ...
  // Revenue data
  const revenueData = [
    { month: 'Jul', rent: 42000, expenses: 12000, net: 30000 },
    { month: 'Aug', rent: 42000, expenses: 11500, net: 30500 },
    { month: 'Sep', rent: 43500, expenses: 13200, net: 30300 },
    { month: 'Oct', rent: 43500, expenses: 11800, net: 31700 },
    { month: 'Nov', rent: 45000, expenses: 14500, net: 30500 },
    { month: 'Dec', rent: 45000, expenses: 12200, net: 32800 },
    { month: 'Jan', rent: 46500, expenses: 13100, net: 33400 }
  ];

  // Portfolio breakdown
  const portfolioData = [
    { name: 'Residential', value: 65, amount: 2080000 },
    { name: 'Multi-Family', value: 30, amount: 960000 },
    { name: 'Commercial', value: 5, amount: 160000 }
  ];
            ...
            <div className="bg-[#1A1A1A] rounded-xl border border-[#2A2A2A] p-6">
              ...
              <ChartContainer height={256} minHeight={256} dependencies={[activeTab]}>
                <BarChart data={revenueData} width={800} height={256}>
                  ...
                  />
                  <Bar dataKey="rent" fill="#ea580c" radius={[8, 8, 0, 0]} isAnimationActive={false} />
                  <Bar dataKey="expenses" fill="#3b82f6" radius={[8, 8, 0, 0]} isAnimationActive={false} />
                </BarChart>
              </ChartContainer>
            </div>
