...
import {
  ...
  Palette, Lock, Crown, ExternalLink
} from 'lucide-react';
...
export default function AdvertiserPortalView() {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'hub' | 'placements' | 'previews' | 'campaigns' | 'media' | 'analytics' | 'billing' | 'performance' | 'referrals'>('dashboard');

  // Subscription tier - determines feature access
  // Tiers: 'basic', 'professional', 'premium', 'elite'
  const [subscriptionTier, setSubscriptionTier] = useUserData<string>('advertiser_subscription_tier', 'basic');
  ...
  const advertiserInfo = {
    ...
    email: 'marketing@premierhome.com',
    phone: '(555) 456-7890',
    accountManager: 'Amanda Stevens',
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-400 mt-1">{advertiserInfo.name}</p>
            </div>
            ...
            <div className="bg-[#1A1A1A] rounded-xl border border-[#2A2A2A] p-6">
              ...
              <ChartContainer height={256} minHeight={256} dependencies={[activeTab]}>
                <LineChart data={performanceData} width={800} height={256}>
                  ...
                  <Line type="monotone" dataKey="conversions" stroke="#22c55e" strokeWidth={2} name="Conversions" isAnimationActive={false} />
                </LineChart>
              </ChartContainer>
            </div>
