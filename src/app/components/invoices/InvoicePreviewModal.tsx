  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#1A1A1A] rounded-2xl border border-[#2A2A2A] w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-8 bg-white text-black print:p-0" id="invoice-content">
            ...
            <div className="flex items-start justify-between mb-6">
              ...
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-orange-600 font-semibold">{companyInfo.tagline}</p>
                  </div>
                </div>
              ...
              <div className="text-right">
                ...
                <div className="text-sm space-y-1">
                  ...
                  <p className="text-gray-600">Issue Date: {formatDate(invoice.issue_date)}</p>
          ...
          <div className="grid grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <div className="text-sm">
                <p className="font-bold text-gray-900 text-lg mb-1">{invoice.customer_name}</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-100 border-b-2 border-gray-300">
                  <th className="text-left py-3 px-4 text-xs font-bold text-gray-700 uppercase">#</th>
                  <th className="text-left py-3 px-4 text-xs font-bold text-gray-700 uppercase">Description</th>
                  <th className="text-right py-3 px-4 text-xs font-bold text-gray-700 uppercase">Qty</th>
                  <th className="text-right py-3 px-4 text-xs font-bold text-gray-700 uppercase">Unit Price</th>
                  <th className="text-right py-3 px-4 text-xs font-bold text-gray-700 uppercase">Amount</th>
                </tr>
              </thead>
              <tbody>
          ...
          {invoice.notes && (
            <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <h3 className="text-xs font-bold text-gray-700 uppercase mb-2">Notes</h3>
          ...
          {invoice.terms && (
            <div className="mb-8 p-4 bg-orange-50 rounded-lg border border-orange-200">
              <h3 className="text-xs font-bold text-orange-700 uppercase mb-2">Payment Terms & Conditions</h3>
              <p className="text-xs text-gray-700 whitespace-pre-wrap leading-relaxed">{invoice.terms}</p>
            </div>
          )}
          ...
          {companyInfo.banking && (
            <div className="mb-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <h3 className="text-xs font-bold text-blue-700 uppercase mb-2">Payment Information</h3>
