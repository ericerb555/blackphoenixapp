...
type ViewMode = 'subscriptions' | 'cohorts' | 'maintenance' | 'vendors' | 'advertisers';
      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="mb-6 flex items-center gap-2 bg-zinc-900 border border-zinc-800 rounded-lg p-2">
          {[
            ...
            { mode: 'maintenance' as ViewMode, icon: Settings, label: 'Maintenance Plans' },
            { mode: 'vendors' as ViewMode, icon: ShoppingBag, label: 'Vendor Plans' },
            { mode: 'advertisers' as ViewMode, icon: Megaphone, label: 'Advertiser Plans' }
          ].map((tab) => {
