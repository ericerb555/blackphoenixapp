...
export const navigationSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Services",           path: "service-scheduling" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Digital Products",    path: "marketplace-admin",   badge: "NEW" },
      ...
      { name: "Partner With Us",     path: "property-partnership", badge: "NEW" },
      { name: "AI Property Studio",  path: "property-ai-studio",   badge: "AI" },
