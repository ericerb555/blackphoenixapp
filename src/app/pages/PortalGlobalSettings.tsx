          ...
          {[
            ...
            <div key={title} className="p-4 bg-[#0A0A0A] rounded-xl space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button className="text-xs text-[#ea580c] hover:text-[#f97316] flex items-center gap-1">
      ...
      <div>
        ...
        <div className="bg-[#1A1A1A] rounded-2xl border border-[#2A2A2A] p-6 space-y-6">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-2">Set to 0 for unlimited</p>
          </div>
      ...
      <div>
        ...
        <div className="bg-[#1A1A1A] rounded-2xl border border-[#2A2A2A] p-6 space-y-6">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-2">Leave empty to allow all IPs</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="bg-[#1A1A1A] rounded-2xl border border-[#2A2A2A] p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-[#0A0A0A] border border-[#2A2A2A] rounded-xl text-white placeholder-gray-500 font-mono text-sm focus:outline-none focus:border-[#ea580c]/50"
            />
            <p className="text-xs text-gray-500 mt-2">Receive notifications in Slack</p>
          </div>
