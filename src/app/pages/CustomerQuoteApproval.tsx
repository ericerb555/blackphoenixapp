                    ...
                    <div key={item.id} className="flex items-start justify-between p-4 bg-[#0A0A0A] rounded-lg">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-sm">
                          ...
                          <span className="px-2 py-1 bg-[#2A2A2A] text-gray-400 rounded text-xs">{item.category}</span>
                        </div>
                      </div>
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div className="absolute top-2 right-2">
                <span className="px-2 py-1 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-xs font-bold rounded-full flex items-center gap-1">
        ...
        <div className="flex gap-4">
          <button
            onClick={() => toast.info('Contract downloaded as PDF')}
            className="flex items-center justify-center gap-2 px-6 py-4 bg-[#1A1A1A] border border-[#2A2A2A] hover:bg-[#2A2A2A] rounded-xl text-white font-bold transition-all"
          >
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-700 hover:shadow-xl hover:shadow-green-600/50 rounded-xl text-white font-bold transition-all"
          >
            <CheckCircle className="w-5 h-5" />
            Sign Contract & Begin Project
            <ArrowRight className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-xl flex items-start gap-3">
          ...
          <div className="flex-1 text-sm text-blue-200">
            <strong className="text-blue-100">Next Steps:</strong> After signing, your deposit payment of ${paymentSchedule[0].amount.toLocaleString()} will be due by {new Date(paymentSchedule[0].dueDate!).toLocaleDateString()}. You'll receive payment instructions via email.
          </div>
        </div>
      </div>
    </div>
