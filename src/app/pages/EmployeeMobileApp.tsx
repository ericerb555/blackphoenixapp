          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-100">Field Technician</p>
              </div>
            </div>
              ...
              <div className={`p-6 text-white ${isClockedIn ? 'bg-gradient-to-br from-green-500 to-green-600' : 'bg-gradient-to-br from-slate-600 to-slate-700'}`}>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    <Badge variant={isClockedIn ? 'success' : 'neutral'} className="text-xs">
                ...
                {isClockedIn && (
                  <div className="mb-4 p-3 bg-white/10 rounded-xl backdrop-blur-sm">
                    <p className="text-xs text-white/80 mb-1">Time Worked Today</p>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-slate-500">Capture site</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-slate-500">For estimates</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-slate-500">PDFs, files</p>
                  </div>
                </button>
                    ...
                    {recentUploads.map((upload) => (
                      <div key={upload.id} className="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg transition-colors">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-slate-500">{upload.time} • {upload.size}</p>
                        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="p-4 bg-green-50 rounded-xl">
                      <p className="text-xs text-green-600 font-semibold mb-1">This Week</p>
          ...
          <>
            <div className="grid grid-cols-2 gap-3 mb-4">
              ...
              >
                ...
                <p className="text-xs text-blue-100 mt-1">Site photos</p>
              </button>
              <button
                onClick={() => handleUpload('video')}
              ...
              >
                ...
                <p className="text-xs text-purple-100 mt-1">CAD/Estimates</p>
              </button>
            </div>
                  ...
                  <div className="aspect-video bg-slate-900 rounded-xl flex items-center justify-center relative overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="bg-white/10 backdrop-blur-lg rounded-lg p-3">
                        <p className="text-white text-xs font-semibold mb-1">Video Capture for:</p>
                        <div className="flex gap-2">
