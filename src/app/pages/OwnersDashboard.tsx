...
type MainTab = 'overview' | 'companies' | 'branding' | 'roles' | 'alerts' | 'transfers' | 'users' | 'settings' | 'financials' | 'ads' | 'modules' | 'access-control';
...
export default function OwnersDashboard({ onNavigate }: OwnersDashboardProps) {
  ...
  const tabs = [
    ...
    { id: 'branding' as MainTab, label: 'Branding & Documents', icon: Palette },
            ...
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {tab.label}
                  {tab.badge && (
                    <span className="px-2 py-0.5 text-xs font-bold bg-[#ea580c] text-white rounded-full">
                      {tab.badge}
                    </span>
                  )}
                </button>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-400">{company.employees} employees • {company.projects} projects</p>
                      </div>
                    </div>
        ...
        {activeTab === 'companies' && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-400 mt-1">Manage all business entities, branding, and settings</p>
            </div>
            <SimpleCompanyManager />
          </div>
        )}

        {/* BRANDING & DOCUMENTS TAB */}
        {activeTab === 'branding' && (
          <div className="space-y-6">
            <CompanyBrandingCenter />
          </div>
        )}
