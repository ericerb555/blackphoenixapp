        ...
        <div className="bg-gradient-to-br from-[#1A1A1A] to-[#151515] border border-gray-700 rounded-xl p-6">
          ...
          <div className="mb-6 p-4 bg-[#0A0A0A] rounded-lg border border-[#ea580c]/30">
            ...
            <input
              ...
              placeholder="30"
            />
            <p className="text-xs text-gray-500 mt-2">Applied to materials without a specific category markup</p>
          </div>
        ...
        <div className="bg-gradient-to-br from-[#1A1A1A] to-[#151515] border border-gray-700 rounded-xl p-6">
          ...
          <div className="mt-6 p-4 bg-[#0A0A0A] rounded-lg border border-blue-500/30">
            ...
            <input
              ...
              placeholder="0"
            />
            <p className="text-xs text-gray-500 mt-2">Additional markup on labor costs (usually 0 - profit comes from rates)</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-4 bg-[#0A0A0A] rounded-lg border border-gray-700">
              ...
              <input
                ...
                placeholder="15"
              />
              <p className="text-xs text-gray-500 mt-2">Percentage added to total for profit</p>
            </div>
            ...
            <div className="p-4 bg-[#0A0A0A] rounded-lg border border-gray-700">
              ...
              <input
                ...
                placeholder="10"
              />
              <p className="text-xs text-gray-500 mt-2">Percentage added for business overhead costs</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-4 bg-[#0A0A0A] rounded-lg border border-gray-700">
              ...
              <input
                ...
                placeholder="8"
              />
              <p className="text-xs text-gray-500 mt-2">Applied to final quote total</p>
            </div>
            ...
            <div className="p-4 bg-[#0A0A0A] rounded-lg border border-gray-700">
              ...
              <input
                ...
                placeholder="15"
              />
              <p className="text-xs text-gray-500 mt-2">Maximum discount percentage allowed on quotes</p>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-[#0A0A0A] rounded-lg border border-gray-700">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Enable discount functionality in quote generation</p>
              </div>
            </label>
          </div>
        </div>
