      ...
      <div className="max-w-[1800px] mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-[#1A1A1A] border border-zinc-800 rounded-xl p-6">
            ...
            <p className="text-xs text-zinc-500 mt-2">Active territory licenses</p>
          </div>
          ...
          <div className="bg-[#1A1A1A] border border-zinc-800 rounded-xl p-6">
            ...
            <p className="text-xs text-zinc-500 mt-2">Vendors, advertisers, subcontractors</p>
          </div>
          ...
          <div className="bg-[#1A1A1A] border border-zinc-800 rounded-xl p-6">
            ...
            <p className="text-xs text-zinc-500 mt-2">ARR: {formatCurrency(stats.monthlyRecurringRevenue * 12)}</p>
          </div>
          ...
          <div className="bg-[#1A1A1A] border border-zinc-800 rounded-xl p-6">
            ...
            <p className="text-xs text-zinc-500 mt-2">{stats.totalTransactions.toLocaleString()} transactions</p>
          </div>
        </div>
            ...
            <div className="bg-[#1A1A1A] border border-zinc-800 rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                >
                  ...
                  <p className="text-xs text-zinc-400">License sale</p>
                </button>
                <button 
                ...
                >
                  ...
                  <p className="text-xs text-zinc-400">Pricing & plans</p>
                </button>
                <button
                ...
                >
                  ...
                  <p className="text-xs text-zinc-400">Reports & analytics</p>
                </button>
                <button
                ...
                >
                  ...
                  <p className="text-xs text-zinc-400">Platform config</p>
                </button>
              </div>
            </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-1">
                          <span className="text-xs text-zinc-500">Admin: {territory.admin_name}</span>
                          <span className="text-xs text-zinc-600">•</span>
                          <span className="text-xs text-zinc-500">{territory.admin_email}</span>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(territory.status)}`}>
                        {territory.status}
                      </span>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    ...
                    <div className="bg-[#0A0A0A] border border-zinc-800 rounded-lg p-3">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs text-zinc-400">License Fee</span>
                      </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#0A0A0A] border-b border-zinc-800">
                    <tr>
                      <th className="px-6 py-4 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wider">Tenant</th>
                      <th className="px-6 py-4 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wider">Type</th>
                      <th className="px-6 py-4 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wider">Territory</th>
                      <th className="px-6 py-4 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wider">Cohort</th>
                      <th className="px-6 py-4 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wider">Status</th>
                      <th className="px-6 py-4 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wider">Revenue</th>
                    ...
                    {tenants.map(tenant => (
                      <tr key={tenant.id} className="hover:bg-zinc-900/50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          ...
                          <p className="text-xs text-zinc-500">{formatCurrency(tenant.monthly_fee)}/mo</p>
                        </td>
                        <td className="px-6 py-4">
            ...
            <div className="bg-[#1A1A1A] border border-zinc-800 rounded-xl p-8 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                <div className="bg-[#0A0A0A] border border-zinc-800 rounded-lg p-6">
                  ...
                  <p className="text-xs text-green-400">+$499 this month</p>
                </div>
                <div className="bg-[#0A0A0A] border border-zinc-800 rounded-lg p-6">
                  ...
                  <p className="text-xs text-green-400">+18% MoM</p>
                </div>
                <div className="bg-[#0A0A0A] border border-zinc-800 rounded-lg p-6">
                  ...
                  <p className="text-xs text-green-400">+12% MoM</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <p className="text-xs text-zinc-400">Customize pricing below</p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-white mb-2">
