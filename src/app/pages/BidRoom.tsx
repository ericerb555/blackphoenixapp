      ...
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className={`text-xs font-normal ${activeSection === 'quotes' ? 'text-blue-100' : 'text-gray-500'}`}>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className={`text-xs font-normal ${activeSection === 'emergency' ? 'text-orange-100' : 'text-gray-500'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-gradient-to-br from-[#ea580c]/20 to-orange-600/20 border border-[#ea580c]/30 rounded-xl p-6">
            ...
            <p className="text-xs text-gray-400 mt-1">Currently accepting bids</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-xl p-6">
            ...
            <p className="text-xs text-gray-400 mt-1">Received from contractors</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-xl p-6">
            ...
            <p className="text-xs text-gray-400 mt-1">Competitive interest</p>
          </div>
                        ...
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                          ...
                          {job.jobCategory && (
                            <>
                              ...
                              <span className="px-2 py-0.5 bg-[#ea580c]/20 text-[#ea580c] text-xs font-bold rounded border border-[#ea580c]/30">
                                {job.jobCategory}
                              </span>
                            </>
                          )}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {job.requirements.slice(0, 3).map((req, idx) => (
                          <span key={idx} className="px-2 py-1 bg-[#0A0A0A] border border-[#2A2A2A] text-gray-300 text-xs rounded">
                            {req}
                          </span>
                        ))}
                        {job.requirements.length > 3 && (
                          <span className="px-2 py-1 bg-[#0A0A0A] border border-[#2A2A2A] text-gray-300 text-xs rounded">
                  ...
                  <div className="lg:w-80 border-l border-[#2A2A2A] lg:pl-6">
                    ...
                    {job.bids.length > 0 ? (
                            ...
                            >
                              <div className="flex items-start justify-between mb-2">
                                <div className="flex-1">
                                  ...
                                  <p className="text-xs text-gray-400">{contractor.company}</p>
                                </div>
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-500 text-xs mt-1">Waiting for contractors</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div>
                        <p className="text-xs text-orange-200 mb-1">Rating</p>
                        <div className="flex items-center gap-1">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 flex-wrap mt-1">
                      ...
                      {selectedJob.jobCategory && (
                        <>
                          <span className="text-gray-600">·</span>
                          <span className="px-2 py-1 bg-[#ea580c]/20 text-[#ea580c] text-xs font-bold rounded border border-[#ea580c]/30">
                            📋 {selectedJob.jobCategory}
                          </span>
                        </>
                      )}
              ...
              <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/30 rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs text-blue-300 mb-1">Customer Name</p>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white text-xs font-bold rounded-lg transition-all"
                  >
                ...
                <div className="flex items-start gap-2 mt-2">
                  ...
                  {newJobForm.jobCategory && (
                    <span className="px-2 py-1 bg-green-500/20 text-green-400 text-xs font-bold rounded border border-green-500/30 whitespace-nowrap">
