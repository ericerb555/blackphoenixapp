    ...
    return (
      ...
      >
        ...
        >
          ...
          {hasMulti && (
            <>
              <span className="absolute bottom-3 right-3 flex items-center gap-1 px-2 py-0.5 rounded-full text-[12px] font-bold text-white opacity-0 group-hover:opacity-100 transition" style={{ background: 'rgba(0,0,0,0.7)' }}>
          ...
          {boosters.stockScarcity?.enabled && product.inStock && typeof product.stock === 'number' && product.stock > 0 && product.stock <= (Number(boosters.stockScarcity.threshold) || 8) && (
            <span className="absolute bottom-3 left-3 px-2.5 py-1 rounded-full text-[12px] font-black shadow-lg" style={{ background: 'rgba(220,38,38,0.92)', color: '#fff' }}>
        ...
        <div className="p-4 flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between mt-1">
            ...
            <button
              ...
              // 44, not 32. This is the add-to-cart on a product card — the
              // conversion action — and on an iPhone it was a third below the
              // minimum tap target, so a customer aiming at it could miss.
              className="px-4 py-2 rounded-xl text-sm font-bold transition hover:scale-105 disabled:opacity-40"
        ...
        <>
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-gray-600 mt-0.5">Our best products, handpicked for you</p>
                </div>
              </div>
                  ...
                  <div key={product.id}
                    ...
                    <div className="relative overflow-hidden bg-black" style={{ aspectRatio: '1' }}>
                      {product.image && product.image !== '/placeholder-product.jpg'
                        ...
                        : <div className="w-full h-full flex flex-col items-center justify-center gap-2">
                            ...
                            <span className="text-[12px] text-gray-700 font-bold tracking-widest uppercase">No Image</span>
                          </div>
                      }
                      {/* Gradient overlay */}
                      ...
                      {/* Discount badge */}
                      {discount > 0 && (
                        <span className="absolute top-2 left-2 text-[12px] font-black px-2 py-0.5 rounded-lg"
                    ...
                    <div className="p-3 flex flex-col gap-1.5 flex-1">
                      ...
                      <div className="flex items-center gap-0.5">
                        ...
                        <span className="text-[12px] text-gray-600 ml-1">({product.reviews})</span>
                      </div>
                      <div className="flex items-center justify-between mt-auto pt-1.5 gap-2">
                        <div className="min-w-0">
                          ...
                          {product.originalPrice && (
                            <div className="text-[12px] text-gray-600 line-through">${product.originalPrice.toFixed(2)}</div>
                          )}
                        </div>
                        <button onClick={e => {
                            e.stopPropagation();
                          ...
                          className="flex-shrink-0 font-black text-[13px] px-3 py-2 rounded-xl transition-all hover:brightness-110 active:scale-95 disabled:opacity-30"
                          style={{ background: '#ea580c', minHeight: 44, whiteSpace: 'nowrap' }}>
          ...
          <section className="max-w-screen-xl mx-auto px-4 pt-2 pb-4">
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <div>
                ...
                <p className="text-[13px] text-gray-600 mt-0.5">Handpicked combos at unbeatable prices</p>
              </div>
            </div>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <p className="text-[13px] text-gray-500 mt-0.5">{bundle.tagline}</p>
                        </div>
                      </div>
                      {/* Product thumbnails */}
                      <div className="flex gap-2 mb-4">
                        ...
                        <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 text-[12px] font-black text-gray-500"
          ...
          <section className="max-w-screen-xl mx-auto px-4 pb-10">
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <div>
                ...
                <p className="text-[13px] text-gray-600 mt-0.5">Real customers, real results</p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {REVIEWS.map((r, i) => (
                <div key={i} className="rounded-2xl p-5 relative overflow-hidden"
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[12px] text-gray-600">{r.role}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', background: '#050505' }}>
            <div className="max-w-screen-xl mx-auto px-4 py-8">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] tracking-widest uppercase" style={{ color: '#ea580c' }}>Family Owned &amp; Operated</p>
                  </div>
                </div>
              ...
              <p className="text-center text-[12px] text-gray-800 mt-6">© 2026 {companyName}. All rights reserved.</p>
            </div>
          </footer>
        </>
      )}
            ...
            <div className="sticky top-0 z-10 px-4 sm:px-6 py-4" style={{ background: '#0d0d0d', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
              ...
              {boosters.urgency?.enabled && urgencyLabel && (
                <div className="mt-3 rounded-xl p-3 flex items-center justify-between gap-2" style={{ background: 'rgba(220,38,38,0.12)', border: '1px solid rgba(220,38,38,0.28)' }}>
                  <p className="text-[13px] sm:text-xs text-red-300 min-w-0 break-words">{boosters.urgency.message}</p>
              ...
              {cart.length === 0 ? (
                ...
                <div key={lineKey} className="flex gap-3 sm:gap-4 p-3 sm:p-4 rounded-2xl" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {variant && <p className="text-[13px] font-semibold text-orange-400 mb-0.5 truncate">{variant}</p>}
            ...
            {cart.length > 0 && (() => {
              ...
              return (
                <div className="px-4 sm:px-6 pb-4">
                  <p className="text-[12px] font-black tracking-widest uppercase text-gray-600 mb-2">You Might Also Like</p>
                    ...
                    {upsells.map(p => (
                      <div key={p.id} className="flex items-center gap-3 p-2.5 rounded-xl transition"
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[13px] font-black" style={{ color: '#fb923c' }}>${p.price.toFixed(2)}</p>
                        </div>
                        <button onClick={() => addToCart(p)}
                          className="flex-shrink-0 text-[12px] font-black px-3 py-1.5 rounded-lg transition hover:brightness-110"
                          style={{ background: '#ea580c' }}>
                          + Add
                        </button>
                      </div>
              ...
              <div className="sticky bottom-0 p-4 sm:p-6" style={{ background: '#0d0d0d', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    {taxState && (
                      <span className="flex flex-shrink-0 items-center px-2.5 sm:px-3 rounded-xl text-[13px] sm:text-xs font-bold text-orange-400 bg-orange-500/10 border border-orange-500/20 whitespace-nowrap">
                ...
                <div className="space-y-2 mb-4 sm:mb-5">
                  ...
                  {taxRate > 0 && (
                    <p className="text-[12px] text-gray-600">Includes ${(cartTotal * taxRate).toFixed(2)} in {taxState} sales tax</p>
                  )}
                </div>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex-1 p-4 sm:p-6">
                <div className="flex items-center flex-wrap gap-2 mb-2 pr-10">
                  {showQuickView.badge && <span className="px-2 py-0.5 rounded-full text-[12px] sm:text-xs font-black" style={{ background: '#ea580c' }}>{showQuickView.badge}</span>}
      ...
      <UnifiedCheckout
        ...
        extraContent={
          <div className="rounded-2xl p-4 space-y-2" style={{ background: '#161616', border: '1px solid rgba(255,255,255,0.07)' }}>
            ...
            {giftCardBalance !== null && <p className="text-[12px] text-gray-500">Available card balance: ${giftCardBalance.toFixed(2)} · Amount due: ${amountDueAfterGiftCard.toFixed(2)}</p>}
          </div>
        }
            ...
            {leadSubmitted ? (
              ...
              <>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-[12px] text-gray-600 text-center">Use code <strong className="text-gray-400">BPBUILDS10</strong> at checkout</p>
                </div>
              </>
            )}
          </div>
              ...
              {trackResult?.order && (
                <div className="mt-2 rounded-xl p-4 space-y-3" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-2.5 py-1 rounded-full text-[13px] font-black uppercase" style={{ background: 'rgba(234,88,12,0.15)', color: '#ea580c' }}>{trackResult.order.status}</span>
                  </div>
                      ...
                      {trackResult.timeline.map((ev: any, i: number) => (
                        <div key={i} className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-[12px] text-gray-500">{new Date(ev.at).toLocaleString()}</p>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  {(trackResult.order.items || []).length > 0 && (
                    <p className="text-[13px] text-gray-500 pt-1">{trackResult.order.items.map((i: any) => `${i.quantity}× ${i.name}`).join(', ')}</p>
                  )}
                </div>
              )}
            </div>
      ...
      <div className="fixed bottom-6 right-5 z-50 flex flex-col items-end gap-3">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <p className="text-[12px] text-orange-100">Online · Replies instantly</p>
                  </div>
                </div>
              </div>
            ...
            <div className="px-3 pb-2 flex gap-1.5 flex-wrap flex-shrink-0">
              {['Shipping info', 'Best deals', 'Returns'].map(q => (
                <button key={q} onClick={() => { setChatInput(q); }}
                  className="text-[12px] font-bold px-2.5 py-1 rounded-full transition"
        ...
        <button
          ...
          {!showChat && chatUnread > 0 && (
            <span className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full flex items-center justify-center text-[12px] font-black text-white"
