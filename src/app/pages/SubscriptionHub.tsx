    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-[#ea580c] to-[#c2410c] rounded-xl p-6 text-white">
          ...
          <div className="mt-2 text-xs opacity-75">↑ 18% from last month</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl p-6 text-white">
          ...
          <div className="mt-2 text-xs opacity-75">↑ 12 new this month</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-xl p-6 text-white">
          ...
          <div className="mt-2 text-xs opacity-75">${totalReferralValue} in conversions</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-xl p-6 text-white">
          ...
          <div className="mt-2 text-xs opacity-75">${totalGiftCardValue} balance</div>
        </div>
      </div>
              ...
              {subscriptionBreakdown.map((item, index) => (
                <div key={index} className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">{item.value} active</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-orange-100">Create & edit plans</div>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-gray-400">Create maintenance plan</div>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-gray-400">Create gift card/hours</div>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-gray-400">Rollover & gifting</div>
            </div>
          </button>
          ...
          <div className="flex items-center justify-between p-3 bg-[#2a2a2a] rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">Sarah Johnson - Premium Plan</div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-3 bg-[#2a2a2a] rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">10 hours - GIFT-HOURS-XYZ789</div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-3 bg-[#2a2a2a] rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">Elite Plumbing → Quick Fix HVAC</div>
              </div>
            </div>
            ...
            <div key={sub.id} className="bg-[#1a1a1a] border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-gray-500">per {sub.billingCycle.replace('ly', '')}</div>
                </div>
              </div>
              ...
              {sub.hoursIncluded !== undefined && (
                <div className="grid grid-cols-4 gap-4 mb-4 p-4 bg-[#2a2a2a] rounded-lg">
                  <div>
                    <div className="text-xs text-gray-400 mb-1">Hours Included</div>
                    <div className="text-lg font-semibold text-white">{sub.hoursIncluded}h</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-400 mb-1">Hours Used</div>
                    <div className="text-lg font-semibold text-orange-400">{sub.hoursUsed}h</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-400 mb-1">Hours Rollover</div>
                    <div className="text-lg font-semibold text-blue-400">{sub.hoursRollover}h</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-400 mb-1">Hours Gifted</div>
          ...
          <div key={ref.id} className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl p-6 hover:border-[#ea580c]/50 transition">
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="text-right">
                ...
                {ref.conversionValue && (
                  <div className="text-xs text-gray-400 mt-1">${ref.conversionValue} value</div>
                )}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-gray-400">Owner giveaway</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-gray-400">End-of-month automation</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-gray-400">Partner giveaways</div>
              </div>
            </button>
          </div>
        </div>
                ...
                <div key={request.id} className="bg-[#1A1A1A] border border-[#ea580c]/20 rounded-lg p-4">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-gray-500">to gift</div>
                    </div>
                  </div>
              ...
              <div key={sub.id} className="bg-[#0A0A0A] border border-[#2A2A2A] rounded-lg p-4">
                ...
                <div className="grid grid-cols-4 gap-3">
                  <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg p-3">
                    <div className="text-xs text-gray-400 mb-1">Included</div>
                  ...
                  <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg p-3">
                    <div className="text-xs text-gray-400 mb-1">Rollover</div>
                    <div className="text-lg font-semibold text-purple-400">{sub.hoursRollover}h</div>
                  </div>
                  <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg p-3">
                    <div className="text-xs text-gray-400 mb-1">Gifted</div>
      ...
      <div className="bg-[#1a1a1a] border border-gray-800 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500">↑ $156 from last month</div>
          </div>
        </div>
      </div>
