                      ...
                      >
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-gray-400">${service.deposit.toFixed(2)} deposit</span>
                          </div>
                        </div>
                      </button>
                    ))}
          ...
          <div className="bg-[#1A1A1A] rounded-xl border border-[#2A2A2A] p-4">
            ...
            <div className="grid grid-cols-7 gap-2">
              {availableDates.map((dateOption) => (
                ...
                >
                  <div className="text-center">
                    <div className="text-xs text-gray-400 mb-1">{dateOption.day}</div>
                    ...
                    {dateOption.isToday && (
                      <div className="mt-2">
                        <span className="text-xs px-2 py-0.5 bg-blue-500/20 text-blue-400 rounded">Today</span>
                      </div>
                    )}
                    {selectedDate === dateOption.date && (
              ...
              <div className="grid grid-cols-5 gap-3">
                {timeSlots.map((slot) => (
                  ...
                  >
                    ...
                    {!slot.available && (
                      <p className="text-xs text-gray-500 mt-1 text-center">Booked</p>
                    )}
                    {selectedTime === slot.time && (
                      <CheckCircle2 className="w-5 h-5 text-orange-400 mx-auto mt-2" />
                    )}
                      ...
                      <div className="pt-3 border-t border-[#2A2A2A]">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {tech.skills.map((skill, i) => (
                            <span key={i} className="px-2 py-1 bg-[#2A2A2A] text-gray-400 rounded text-xs">
                              {skill}
                            </span>
                          ))}
                        </div>
