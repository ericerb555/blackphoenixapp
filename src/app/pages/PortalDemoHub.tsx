          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="p-4 bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-gray-400">Portal Types</span>
              </div>
              <div className="text-3xl font-bold text-white">{PORTALS.length}</div>
              <div className="text-sm text-gray-500 mt-2">Available for demo</div>
            </div>
            ...
            <div className="p-4 bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-gray-400">Demo Status</span>
              </div>
              <div className="text-3xl font-bold text-white">Live</div>
              <div className="text-sm text-gray-500 mt-2">Fully interactive</div>
            </div>
            ...
            <div className="p-4 bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl hover:border-orange-500/30 transition-all duration-300">
              ...
              <div className="text-sm text-gray-500 mt-2">Preserved functionality</div>
            </div>
          </div>
