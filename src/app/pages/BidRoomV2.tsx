...
export default function BidRoomV2() {
  ...
  const getOwnerStatusBadge = (status: string) => {
    switch (status) {
      case 'pending':
        return <span className="px-3 py-1 bg-yellow-500/20 text-yellow-400 text-xs font-semibold rounded-full">⏳ Pending Review</span>;
      case 'reviewing':
        return <span className="px-3 py-1 bg-blue-500/20 text-blue-400 text-xs font-semibold rounded-full">👀 Reviewing</span>;
      case 'editing':
        return <span className="px-3 py-1 bg-purple-500/20 text-purple-400 text-xs font-semibold rounded-full">✏️ Editing</span>;
      case 'approved':
        return <span className="px-3 py-1 bg-green-500/20 text-green-400 text-xs font-semibold rounded-full">✅ Approved</span>;
      case 'rejected':
        return <span className="px-3 py-1 bg-red-500/20 text-red-400 text-xs font-semibold rounded-full">❌ Rejected</span>;
      default:
        return null;
    }
  };
        ...
        <div className="max-w-[1800px] mx-auto">
          ...
          <div className="grid grid-cols-5 gap-4">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4">
              ...
              <p className="text-xs text-orange-100 mt-1">Awaiting review</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4">
              ...
              <p className="text-xs text-orange-100 mt-1">Ready to send</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4">
              ...
              <p className="text-xs text-orange-100 mt-1">Delivered</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4">
              ...
              <p className="text-xs text-orange-100 mt-1">All responses</p>
            </div>
          </div>
        </div>
      </div>
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2 flex-wrap">
                            ...
                            {job.quoteNumber && (
                              <span className="px-3 py-1 bg-blue-500/20 border border-blue-500/30 text-blue-300 text-xs font-bold rounded-full">
                                {job.quoteNumber}
                              </span>
                            )}
                          </div>
