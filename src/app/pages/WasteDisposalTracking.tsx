          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
            <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className={`text-xs flex items-center gap-1 ${stats.trendsVsPreviousMonth.waste < 0 ? 'text-green-400' : 'text-red-400'}`}>
            ...
            <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className={`text-xs flex items-center gap-1 ${stats.trendsVsPreviousMonth.cost < 0 ? 'text-green-400' : 'text-red-400'}`}>
              ...
              <div className="text-xs text-gray-400">Disposal Costs</div>
            </div>
            ...
            <div className="bg-[#1A1A1A] border border-green-500/20 rounded-xl p-4">
              ...
              <div className="text-xs text-gray-400">Recycling Rate</div>
            </div>
            ...
            <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl p-4">
              ...
              <div className="text-xs text-gray-400">Avg Cost/Project</div>
            </div>
            ...
            <div className="bg-[#1A1A1A] border border-yellow-500/20 rounded-xl p-4">
              ...
              <div className="text-xs text-gray-400">Hazardous Waste</div>
            </div>
                      ...
                      <div className="flex items-start gap-4 flex-1">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className={`px-2 py-1 rounded-lg text-xs font-medium ${getStatusColor(entry.status)} bg-current/10`}>
                              {entry.status.replace('_', ' ').toUpperCase()}
                            </span>
                            {entry.wasteType === 'hazardous' && (
                              <span className="px-2 py-1 rounded-lg text-xs font-medium bg-yellow-500/10 text-yellow-400 flex items-center gap-1">
