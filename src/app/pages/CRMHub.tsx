        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="px-3 py-1 rounded-full bg-orange-500/20 border border-orange-500/30 text-orange-300 text-xs font-bold inline-block mb-4">
                🔥 FEATURED
              </div>
          ...
          <div className="relative p-8 rounded-2xl border-2 border-[#2A2A2A] bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] opacity-60">
            ...
            <div className="px-3 py-1 rounded-full bg-gray-500/20 border border-gray-500/30 text-gray-400 text-xs font-bold inline-block">
              COMING SOON
            </div>
          </div>
