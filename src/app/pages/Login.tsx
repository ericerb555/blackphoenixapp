        ...
        <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-3xl p-20">
          <form onSubmit={handleLogin} className="space-y-13">
            ...
            <div>
              ...
              <div className="flex items-center bg-[#0A0A0A] border-2 border-[#2A2A2A] rounded-xl focus-within:border-[#ea580c] transition">
                <div className="flex-shrink-0 flex items-center justify-center w-20 h-full py-8">
                  <Mail className="w-9 h-9 text-gray-500" />
                </div>
                <input
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  className="flex-1 min-w-0 pr-8 py-8 bg-transparent text-white text-2xl placeholder-gray-500 focus:outline-none"
            ...
            <div>
              ...
              <div className="flex items-center bg-[#0A0A0A] border-2 border-[#2A2A2A] rounded-xl focus-within:border-[#ea580c] transition">
                ...
                <input
                  ...
                  className="flex-1 min-w-0 py-8 bg-transparent text-white text-2xl placeholder-gray-500 focus:outline-none"
                  placeholder="••••••••"
                  required
                />
                <button
                  ...
                  className="flex-shrink-0 flex items-center justify-center w-20 h-full py-8 text-gray-500 hover:text-gray-400 transition"
                >
