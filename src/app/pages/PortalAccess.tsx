                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {role.features.slice(0, 2).map((feature, idx) => (
                        <span key={idx} className="px-2 py-1 bg-[#2A2A2A] text-gray-300 rounded text-xs">
                          {feature}
                        </span>
                      ))}
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="px-2 py-1 bg-purple-600/20 text-purple-400 rounded text-xs font-bold border border-purple-500/30">
                    ENABLED BY ADMIN
                  </span>
                </div>
              ...
              <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="px-2 py-1 bg-blue-600/20 text-blue-400 rounded text-xs font-bold border border-blue-500/30">
                    ENABLED BY ADMIN
                  </span>
                </div>
              ...
              <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="px-2 py-1 bg-green-600/20 text-green-400 rounded text-xs font-bold border border-green-500/30">
                    ADMIN CONTROLLED
                  </span>
                </div>
