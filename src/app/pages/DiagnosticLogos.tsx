      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm text-gray-500">(company_branding_profile)</span>
          </div>
          ...
          {brandingData ? (
            <div className="space-y-4">
              ...
              <details className="bg-[#0A0A0A] border border-[#2A2A2A] rounded-lg p-4">
                ...
                <pre className="mt-4 text-sm overflow-auto max-h-96 text-gray-300">
        ...
        <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm text-gray-500">(brand_data_*)</span>
          </div>
        ...
        <div className="bg-gradient-to-br from-[#ea580c]/10 to-[#c2410c]/10 border border-[#ea580c]/30 rounded-xl p-6">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-[#ea580c] flex items-center justify-center text-sm font-bold flex-shrink-0">
                1
              </div>
              <div>
        ...
        <details className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl p-6 mt-6">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
            {allStorageKeys.map((key) => (
              <div
                key={key}
                className="bg-[#0A0A0A] border border-[#2A2A2A] rounded px-3 py-2 text-sm font-mono text-gray-400 hover:text-white hover:border-[#ea580c]/30 transition-colors"
              >
                {key}
              </div>
            ))}
