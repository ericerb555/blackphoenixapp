            ...
            <table className="w-full">
              <thead className="bg-[#0A0A0A]">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Categories</th>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Connected</th>
                  ...
                  <tr key={vendor.id} className="hover:bg-[#0A0A0A] transition">
                    ...
                    <td className="px-6 py-4">
                      {vendor.status === 'active' && (
                        <span className="px-3 py-1 bg-green-500/20 text-green-400 text-xs font-semibold rounded-full flex items-center gap-1 w-fit">
                          <CheckCircle className="w-3 h-3" />
                          Active
                        </span>
                      )}
                      {vendor.status === 'pending' && (
                        <span className="px-3 py-1 bg-yellow-500/20 text-yellow-400 text-xs font-semibold rounded-full flex items-center gap-1 w-fit">
                          <Clock className="w-3 h-3" />
                          Pending
                        </span>
                      )}
                      {vendor.status === 'suspended' && (
                        <span className="px-3 py-1 bg-red-500/20 text-red-400 text-xs font-semibold rounded-full flex items-center gap-1 w-fit">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        {vendor.configured ? (
                          ...
                          <span className="px-2 py-0.5 bg-yellow-500/20 text-yellow-400 text-xs font-semibold rounded-full flex items-center gap-1">
