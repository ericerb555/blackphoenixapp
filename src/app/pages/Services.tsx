              ...
              <div className="flex items-center gap-2">
                {stat.trend === 'up' ? (
                  ...
                  <div className="flex items-center gap-1 px-2 py-1 bg-red-600/20 rounded-lg">
                    ...
                    <span className="text-xs font-semibold text-red-400">{stat.change}%</span>
                  </div>
                )}
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`px-2 py-1 rounded-lg text-xs font-bold ${colorClasses.bg} ${colorClasses.text}`}>
                        {category.count}
                      </span>
                    </div>
                  </button>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="px-2 py-0.5 rounded-md text-xs font-semibold bg-green-600/20 text-green-400 border border-green-500/20">
                        ACTIVE
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      {service.linkedId && (
                        <span className="px-2 py-0.5 rounded-md text-xs font-semibold bg-blue-600/20 text-blue-400 border border-blue-500/20 flex items-center gap-1">
