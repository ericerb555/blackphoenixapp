  ...
  const tabCategories: TabCategory[] = [
    ...
    },
    {
      ...
      modules: [
        ...
        { label: 'Landing Pages', path: '/design-structural-hub', tab: 'landing-pages', icon: Globe, color: 'cyan', description: 'Page builder' },
        ...
        { label: 'Landing Page', path: '/landing-page', icon: Globe, color: 'blue', description: 'Main landing page' },
      ]
    },
    {
      id: 'systems',
      ...
      icon: Settings,
      modules: [
        { label: 'CRM Hub', path: '/crm', icon: Users, color: 'blue', description: 'Unified CRM command center with multiple CRM systems', badge: 'NEW' },
          ...
          <div className={`${
            ...
            {sidebarCollapsed ? (
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-gray-400">$245K</span>
              </div>
            ) : (
              <>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className={`flex items-center gap-1 text-xs ${getTrendColor(revenueTrend)}`}>
          ...
          <div className={`${
            ...
            {sidebarCollapsed ? (
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-gray-400">{activeJobsCount}</span>
              </div>
            ) : (
              <>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className={`flex items-center gap-1 text-xs ${getTrendColor(jobsTrend)}`}>
          ...
          <div className={`${
            ...
            {sidebarCollapsed ? (
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-gray-400">{customersCount}</span>
              </div>
            ) : (
              <>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className={`flex items-center gap-1 text-xs ${getTrendColor(customersTrend)}`}>
                ...
                <div className="text-xs text-gray-500 mt-2">Active accounts</div>
              </>
            )}
          </div>
          ...
          <div className={`${
            ...
            {sidebarCollapsed ? (
              ...
              <>
                ...
                <div className="text-xs text-gray-500 mt-2">Employees</div>
              </>
            )}
          </div>
            ...
            >
              {sidebarCollapsed ? (
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-red-400 mt-1">{alertCount}</span>
                </div>
              ) : (
                <>
                  <div className="flex items-center justify-between">
                      ...
                      <div className="relative w-10 h-10 rounded-lg bg-red-500/10 flex items-center justify-center">
                        ...
                        {alertCount > 0 && (
                          <div className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full flex items-center justify-center">
                            <span className="text-white text-xs font-bold animate-pulse">{alertCount}</span>
                          </div>
                        )}
                      </div>
                      <div>
                        <p className="text-sm font-bold text-white">Admin Alerts</p>
                        <p className="text-xs text-gray-400">{alertCount} pending</p>
                      </div>
                    </div>
            ...
            >
              {sidebarCollapsed ? (
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-orange-400 mt-1">NEW</span>
                </div>
              ) : (
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Manage opportunities</p>
                    </div>
                  </div>
                  <span className="px-2 py-0.5 rounded-full text-xs bg-orange-500/20 text-orange-300">NEW</span>
                </div>
              )}
            </button>
          )}
          ...
          >
            {sidebarCollapsed ? (
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-purple-400 mt-1">{activeJobsCount}</span>
              </div>
            ) : (
              <>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">{activeJobsCount} active jobs</p>
                    </div>
                  </div>
                      ...
                      <div className="absolute -top-2 -right-2 z-20">
                        <div className="relative">
                          <div className="w-8 h-8 rounded-full bg-red-500 flex items-center justify-center shadow-lg shadow-red-500/50 animate-pulse">
                            <span className="text-white text-xs font-bold">{pendingApprovalsCount}</span>
                          </div>
