                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className={`px-2 py-1 rounded text-xs font-semibold ${statusBadge.bg} ${statusBadge.text}`}>
                            {statusBadge.label}
                          </span>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      ...
                      <div className="bg-[#0A0A0A] border border-zinc-800 rounded-lg p-3">
                        <p className="text-xs text-zinc-400 mb-1">Last Order</p>
                        <p className="text-sm font-semibold text-white">{supplier.lastOrder}</p>
                      </div>
                      <div className="bg-[#0A0A0A] border border-zinc-800 rounded-lg p-3">
                        <p className="text-xs text-zinc-400 mb-1">Avg Order</p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="bg-[#0A0A0A] border border-zinc-800 rounded-lg p-3">
                        <p className="text-xs text-zinc-400 mb-1">Expected Delivery</p>
