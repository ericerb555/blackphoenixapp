            ...
            >
              ...
              {customer.tags && customer.tags.length > 0 && (
                <div className="flex flex-wrap gap-2 mb-4">
                  {customer.tags.slice(0, 3).map((tag) => (
                    <span key={tag} className="px-2 py-1 text-xs font-semibold rounded-full bg-[#0A0A0A] text-gray-400 border border-[#2A2A2A]">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-4 gap-2 mt-4">
                <button 
                  ...
                  className="flex items-center justify-center gap-1 px-2 py-2 bg-blue-600/10 hover:bg-blue-600/20 rounded-lg text-blue-400 text-xs font-semibold transition border border-blue-500/20"
                >
                ...
                <button 
                  ...
                  className="flex items-center justify-center gap-1 px-2 py-2 bg-orange-600/10 hover:bg-orange-600/20 rounded-lg text-orange-400 text-xs font-semibold transition border border-orange-500/20"
                >
                ...
                <button 
                  onClick={(e) => {e.stopPropagation();}}
                  className="flex items-center justify-center gap-1 px-2 py-2 bg-[#0A0A0A] hover:bg-[#2A2A2A] rounded-lg text-gray-400 text-xs font-semibold transition border border-[#2A2A2A]"
                >
                ...
                <button 
                  ...
                  className="flex items-center justify-center gap-1 px-2 py-2 bg-red-600/10 hover:bg-red-600/20 rounded-lg text-red-400 text-xs font-semibold transition border border-red-500/20"
                >
