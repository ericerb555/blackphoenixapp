...
export const DIRECTORY_SECTIONS: DirectorySection[] = [
  ...
  },
  {
    ...
    navigate: 'advertiser-application',
  ...
  },
  {
    ...
    description: 'Build your career with Black Phoenix. We offer competitive pay, benefits, training, and growth opportunities for skilled trades and professionals.',
    icon: Briefcase,
    gradient: 'from-violet-600 to-purple-600',
    glowColor: 'violet',
    image: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=800&q=80',
    navigate: 'employee-portal',
    portalRoute: 'employee-portal',
    benefits: ['Competitive Pay', 'Health Benefits', 'Career Growth', 'Skills Training'],
    cohortType: 'employee'
  },
  {
    id: 12,
