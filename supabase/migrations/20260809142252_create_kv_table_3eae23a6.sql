...
CREATE TABLE IF NOT EXISTS kv_store_3eae23a6 (
  key   TEXT  NOT NULL PRIMARY KEY,
  value JSONB NOT NULL
);
ALTER TABLE kv_store_3eae23a6 ENABLE ROW LEVEL SECURITY;
CREATE INDEX ON kv_store_3eae23a6 (key text_pattern_ops);
