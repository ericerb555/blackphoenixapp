...
CREATE TABLE IF NOT EXISTS kv_store_57095a78 (
  key   TEXT  NOT NULL PRIMARY KEY,
  value JSONB NOT NULL
);
ALTER TABLE kv_store_57095a78 ENABLE ROW LEVEL SECURITY;
CREATE INDEX ON kv_store_57095a78 (key text_pattern_ops);
