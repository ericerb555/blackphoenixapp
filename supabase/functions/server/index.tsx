...
app.get('/make-server-3eae23a6/investments/opportunities', async (c) => {
  try {
...
app.get('/make-server-3eae23a6/investments/opportunities/:id', async (c) => {
  try {
...
// Create opportunity
app.post('/make-server-3eae23a6/investments/opportunities', async (c) => {
  try {
    const body = await c.req.json();
    const { data, error } = await supabase
      .from('investment_opportunities')
...
// Update opportunity
app.put('/make-server-3eae23a6/investments/opportunities/:id', async (c) => {
  try {
    const id = c.req.param('id');
    const body = await c.req.json();
    const { data, error } = await supabase
...
// Delete opportunity
app.delete('/make-server-3eae23a6/investments/opportunities/:id', async (c) => {
  try {
    const id = c.req.param('id');
...
app.get('/make-server-3eae23a6/investments/commitments/investor/:email', async (c) => {
  try {
...
// Create commitment
app.post('/make-server-3eae23a6/investments/commitments', async (c) => {
  try {
    const body = await c.req.json();
    const { data, error } = await supabase
      .from('investor_commitments')
...
// Update commitment
app.put('/make-server-3eae23a6/investments/commitments/:id', async (c) => {
  try {
    const id = c.req.param('id');
    const body = await c.req.json();
    const { data, error } = await supabase
...
app.get('/make-server-3eae23a6/investments/payouts/investor/:email', async (c) => {
  try {
    const email = c.req.param('email');
    const { data, error } = await supabase
...
// Create payout
app.post('/make-server-3eae23a6/investments/payouts', async (c) => {
  try {
    const body = await c.req.json();
    const { data, error } = await supabase
      .from('payout_distributions')
...
// Update payout
app.put('/make-server-3eae23a6/investments/payouts/:id', async (c) => {
  try {
    const id = c.req.param('id');
    const body = await c.req.json();
...
app.get('/make-server-3eae23a6/investments/documents/opportunity/:id', async (c) => {
  try {
    const id = c.req.param('id');
    const { data, error } = await supabase
...
// Sign document
app.post('/make-server-3eae23a6/investments/documents/:id/sign', async (c) => {
  try {
    const id = c.req.param('id');
...
app.get('/make-server-3eae23a6/investments/analytics/portfolio/:email', async (c) => {
  try {
    const email = c.req.param('email');
