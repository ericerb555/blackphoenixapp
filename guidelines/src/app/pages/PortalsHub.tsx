          ...
          <div className="px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-orange-600/20 border border-orange-500/50 rounded-lg">
                ...
                <span className="text-sm font-semibold text-orange-300">PREVIEW MODE</span>
              </div>
            </div>
          </div>
        </div>
                  ...
                  {COLOR_OPTIONS.map((color) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="text-sm text-gray-400 mt-2">{color.label}</p>
                      </button>
                    );
                  })}
                </div>
        ...
        {showAIAssistant && (
          <div className="w-96 bg-[#0F0F0F] border-l border-[#2A2A2A] flex flex-col">
            ...
            <div className="p-4 border-b border-[#2A2A2A]">
              ...
              <p className="text-sm text-gray-400">Powered by AI to help you create the perfect portal</p>
            </div>
            ...
            <div className="p-4 border-t border-[#2A2A2A]">
              ...
              <p className="text-sm text-gray-500 mt-2">Try: "Create a contractor portal" or "I need a tenant portal"</p>
            </div>
          </div>
        )}
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="p-4 bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl hover:border-orange-500/30 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-gray-400">Total Portals</span>
              </div>
              <div className="text-3xl font-bold text-white">{portals.length}</div>
              <div className="text-sm text-gray-500 mt-2">Active configurations</div>
            </div>
            ...
            <div className="p-4 bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl hover:border-orange-500/30 transition-all duration-300">
              ...
              <div className="text-sm text-gray-500 mt-2">Available to users</div>
            </div>
            ...
            <div className="p-4 bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl hover:border-orange-500/30 transition-all duration-300">
              ...
              <div className="text-sm text-gray-500 mt-2">Available templates</div>
            </div>
          </div>
            ...
            {portals.map((portal) => {
              ...
              return (
                ...
                >
                  {/* Enabled Badge */}
                  {!portal.enabled && (
                    <div className="absolute top-3 right-3 px-2 py-1 bg-gray-600/20 border border-gray-500/30 rounded text-sm text-gray-400">
                      Disabled
                    </div>
                  )}
