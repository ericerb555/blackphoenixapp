          ...
          {filteredPortals.map((portal) => {
            ...
            return (
              ...
              >
                ...
                {/* Status Badge */}
                <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-lg text-sm font-semibold border mb-4 ${getStatusColor(portal.status)}`}>
              ...
              {filteredPortals.map((portal) => {
                ...
                return (
                  <tr key={portal.id} className="border-b border-[#2A2A2A] hover:bg-[#0A0A0A] transition">
                    ...
                    <td className="px-6 py-4">
                      <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-lg text-sm font-semibold border ${getStatusColor(portal.status)}`}>
                        <StatusIcon className="w-3 h-3" />
                        {portal.status.replace('_', ' ').toUpperCase()}
                      </div>
                    </td>
